...
import 'package:qareeb/data/model/body/delivery_man_body.dart';
import 'package:qareeb/data/model/body/store_body.dart';
import 'package:qareeb/data/model/body/signup_body.dart';
...
import 'package:qareeb/data/model/response/zone_model.dart';
...
class AuthController extends GetxController implements GetxService {
  ...
  List<ZoneModel> get zonesList => _zonesList;
  ...
  Future<void> getZonesList() async {
    ...
    if (response.statusCode == 200) {
      ...
      response.body.forEach((zone) => _zonesList.add(ZoneModel.fromJson(zone)));
    } else {
      ApiChecker.checkApi(response);
    }
    update();
