...
import 'package:qareeb/view/screens/auth/widget/code_picker_widget.dart';
import 'package:qareeb/view/screens/auth/widget/condition_check_box.dart';
import 'package:qareeb/view/screens/auth/widget/guest_button.dart';
                        ...
                        child: Container(
                          ...
                          child: GetBuilder<AuthController>(builder: (authController) {
                            return Column(children: [
                              Image.asset(Images.logo, width: 170,height: 130,color: Colors.white,),
                              // SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                              // Center(child: Text(AppConstants.APP_NAME, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge))),
                              SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_LARGE),

                              Text('sign_in'.tr.toUpperCase(),
                                  style: robotoRegular.copyWith(fontSize: 25,fontWeight: FontWeight.w500,color: Colors.white)),
                              SizedBox(height: 20),
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.end,
                                  ...
                                  children: [
                                    ...
                                    TextButton(
                                      ...
                                      child: Text('${'forgot_password'.tr}؟ ',style: TextStyle(color: Color(0xffFF6F05)),),
                                    ),
                                  ]),
