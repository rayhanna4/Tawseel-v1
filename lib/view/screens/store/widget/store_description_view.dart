...
class StoreDescriptionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      SizedBox(height: ResponsiveHelper.isDesktop(context) ? 30 : Dimensions.PADDING_SIZE_DEFAULT),
      ...
      Row(children: [
        ...
        InkWell(
          ...
          child: Column(children: [
            Icon(Icons.location_on_sharp, color: Theme.of(context).primaryColor, size: 20),
            SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
