...
import 'package:qareeb/data/model/response/category_model.dart';
...
import 'package:qareeb/view/screens/store/widget/store_description_view.dart';
            ...
            slivers: [
              ...
              (storeController.categoryList.length > 0) ? SliverPersistentHeader(
                ...
                delegate: SliverDelegate(child: Center(child: Container(
                  height: 90, width: Dimensions.WEB_MAX_WIDTH, color: Theme.of(context).cardColor,
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Text(
                              ...
                              style: index == storeController.categoryIndex
                                  ...
                                  : robotoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
                            ),
