import 'package:qareeb/data/model/response/choose_us_model.dart';
import 'package:qareeb/data/model/response/language_model.dart';
import 'package:qareeb/util/images.dart';

class AppConstants {
  static const String APP_NAME = 'سريع - Saree3';
  static const double APP_VERSION = 1.0;

  static const String BASE_URL = 'https://rany.tictactoe.co.il';
