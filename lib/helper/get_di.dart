...
import 'package:qareeb/controller/chat_controller.dart';
import 'package:qareeb/controller/coupon_controller.dart';
import 'package:qareeb/controller/localization_controller.dart';
import 'package:qareeb/controller/location_controller.dart';
import 'package:qareeb/controller/notification_controller.dart';
import 'package:qareeb/controller/onboarding_controller.dart';
import 'package:qareeb/controller/order_controller.dart';
...
import 'package:qareeb/data/repository/auth_repo.dart';
import 'package:qareeb/data/repository/banner_repo.dart';
import 'package:qareeb/data/repository/campaign_repo.dart';
import 'package:qareeb/data/repository/cart_repo.dart';
import 'package:qareeb/data/repository/category_repo.dart';
import 'package:qareeb/data/repository/coupon_repo.dart';
import 'package:qareeb/data/repository/language_repo.dart';
import 'package:qareeb/data/repository/location_repo.dart';
import 'package:qareeb/data/repository/notification_repo.dart';
import 'package:qareeb/data/repository/onboarding_repo.dart';
import 'package:qareeb/data/repository/order_repo.dart';
import 'package:qareeb/data/repository/item_repo.dart';
import 'package:qareeb/data/repository/parcel_repo.dart';
import 'package:qareeb/data/repository/store_repo.dart';
import 'package:qareeb/data/repository/search_repo.dart';
import 'package:qareeb/data/repository/splash_repo.dart';
import 'package:qareeb/data/api/api_client.dart';
import 'package:qareeb/data/repository/user_repo.dart';
import 'package:qareeb/data/repository/wallet_repo.dart';
import 'package:qareeb/data/repository/wishlist_repo.dart';
